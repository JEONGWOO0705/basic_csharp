namespace Assistant_Workout
{
    partial class Frm_Main
    {
        ...
        private void InitializeComponent()
        {
            ...
            Txtfive = new TextBox();
            Txtone = new TextBox();
            Chkthree = new CheckBox();
            Chkfive = new CheckBox();
            Chkfour = new CheckBox();
            Chktwo = new CheckBox();
            Chkone = new CheckBox();
            CboFifth = new ComboBox();
            CboFourth = new ComboBox();
            CboThird = new ComboBox();
            CboSecond = new ComboBox();
            CboFirst = new ComboBox();
            LstDoit = new ListBox();
            BtnLeg = new Button();
            BtnBack = new Button();
            BtnChest = new Button();
            ...
            groupBox1.Controls.Add(Txtfour);
            groupBox1.Controls.Add(Txtthree);
            groupBox1.Controls.Add(Txttwo);
            groupBox1.Controls.Add(Txtfive);
            groupBox1.Controls.Add(Txtone);
            groupBox1.Controls.Add(Chkthree);
            groupBox1.Controls.Add(Chkfive);
            groupBox1.Controls.Add(Chkfour);
            groupBox1.Controls.Add(Chktwo);
            groupBox1.Controls.Add(Chkone);
            groupBox1.Controls.Add(CboFifth);
            groupBox1.Controls.Add(CboFourth);
            groupBox1.Controls.Add(CboThird);
            groupBox1.Controls.Add(CboSecond);
            groupBox1.Controls.Add(CboFirst);
            groupBox1.Controls.Add(LstDoit);
            groupBox1.Controls.Add(BtnLeg);
        ...
        private ComboBox CboFifth;
        private ComboBox CboFourth;
        private ComboBox CboThird;
        private ComboBox CboSecond;
        private ComboBox CboFirst;
