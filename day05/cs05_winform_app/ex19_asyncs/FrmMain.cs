namespace ex19_asyncs
{
    public partial class FrmMain : Form
    {
        ...
        // 비동기 처리시 async, await 키워드가 가장 중요하다
        // async 나는 비동기 메서드야!!! 라고 정의하는 것
        // await  비동기 메서드가 끝날때 까지 기다릴게 정의
        // 비동기를 처리하는 메서드 이름이 ...Async()
        // async는 메서드 리턴값 앞에 작석, 리턴 값은 Task<리턴값> 
